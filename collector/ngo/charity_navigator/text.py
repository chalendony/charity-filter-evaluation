...
files = glob.glob(
    '/Users/stewarta/repos/charity_navigator-filter-evaluation/evaluation/data/raw/charity_navigator/organization_home/*.html')
# files = ['/Users/stewarta/repos/charity_navigator-filter-evaluation/evaluation/data/raw/charity_navigator/organization_home/3204.html']
corpus = []
...
df.to_csv('/Users/stewarta/repos/charity_navigator-filter-evaluation/evaluation/data/charity_navigator.csv')
